...
while True:#keep making new walks, as long as program is active
    rw = RandomWalk(50_000)#call fill walk from random walk module
    rw.fill_walk()

    #plotting points of walk
    plt.style.use('classic')
    fig, ax = plt.subplots(figsize=(10,6))#tuple for figsize gives it the size in inches (1 inch == 100 pixels on most systems) but dpi lets you fix this if needed
